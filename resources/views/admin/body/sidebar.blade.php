    ...
    <div id="sidebar" class="sidebar sidebar-with-footer">
        ...
        <div class="app-brand">
            <a href="{{route('dashboard')}}">
                ...
                <span class="brand-name">Campany Dashboard</span>
            </a>
        </div>
            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                <li  class="has-sub active expand" >
                    ...
                    <ul  class="collapse show"  id="dashboard"
                        ...
                        <div class="sub-menu">
                            <li  class="active" >
                                <a class="sidenav-item-link" target="_blank" href="{{route('home')}}">
                                    <span class="nav-text">WEBSITE HOME</span>
                                </a>
                            </li>
                            ...
                            <li  class="active" >
                                <a class="sidenav-item-link" href="{{route('about.index')}}">
                                    <span class="nav-text">About management</span>
                                </a>
                            </li>
                            <li  class="active" >
                                <a class="sidenav-item-link" href="{{route('multi.images')}}">
                                    <span class="nav-text">Images management</span>
                                </a>
                            </li>
