                ...
                <div class="card-header bg-primary">
                    <div class="app-brand">
                        <a href="/index.html">
                            ...
                            <span class="brand-name">Sign Up To Dashboard</span>
                        </a>
                    </div>
                </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                <input name="name" type="text" class="form-control input-lg" id="name" aria-describedby="nameHelp" placeholder="Name">
                            </div>
                            <div class="form-group col-md-12 mb-4">
                                <input name="email" type="email" class="form-control input-lg" id="email" aria-describedby="emailHelp" placeholder="Your E-mail">
                            </div>
